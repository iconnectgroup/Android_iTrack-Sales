...
import com.itrack.Interface.NLevelListItem;

import java.util.ArrayList;
import java.util.List;

public class NLevelAdapter1 extends BaseAdapter {
    ...
    public NLevelAdapter1(List<NLevelItem> list) {
        this.list = list;
    ...
    class NLevelFilter {
        ...
        class AsyncFilter extends AsyncTask<Void, Void, ArrayList<NLevelListItem>> {
            ...
            protected void onPostExecute(ArrayList<NLevelListItem> result) {
                setFiltered(result);
                NLevelAdapter1.this.notifyDataSetChanged();
            }
        }
    }
